...
Urban8Kdir = "./urbansound/UrbanSound8K/audio/"
...
inp_folder = "./dataset/urbansound/US_Class"+str(noise_type)+"_Train_Input"
op_folder = "./dataset/urbansound/US_Class"+str(noise_type)+"_Train_Output"
...
inp_folder = "./dataset/urbansound/US_Class"+str(noise_type)+"_Test_Input"
